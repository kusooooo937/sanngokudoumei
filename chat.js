const socket = io('https://sanngokudoumei.onrender.com'); // Render URLに差し替え
...
joinBtn.addEventListener('click', () => {
  ...
  socket.emit('joinRoom', { room, name: nameInput.value || userName, id: userId });
});
